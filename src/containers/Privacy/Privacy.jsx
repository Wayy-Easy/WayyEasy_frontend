...
const Privacy = () => {
  return (
    <Paper className={privacy.privacyContainer}>
      <h2>Privacy Policy for WayyEasy</h2>
      <div className={privacy.policy}>
        <h1 style={{ marginTop: "60px" }}>Privacy Policy</h1>
        <p>
      ...
      <hr />
      <div className={privacy.otherSection}>
        ...
        <ul>
          ...
          <li>
            <b>Application</b> refers to WayyEasy, the software program provided
            by the Company.
          </li>
          <li>
            <b>Company</b> (referred to as either "the Company", "We", "Us" or
            "Our" in this Agreement) refers to WayyEasy , 2a BrickField Lane
            Kolkata 700039.
          </li>
          <li>
          ...
          <li>
            <b>Social Media</b> refers to WayyEasy other social media platforms,
            <ul>
              <li>
                <a
                  href="https://www.linkedin.com/company/wayyeasy/"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://www.facebook.com/WayyEasy"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Facebook
              ...
              <li>
                <a
                  href="https://www.instagram.com/wayyeasy/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Instagram
          ...
          <li>
            <b>Website</b> refers to WayyEasy , accessible from{" "}
            <a
              href="http://www.wayyeasy.in"
              target="_blank"
              rel="noopener noreferrer"
            >
              wayyeasy.in
      ...
      <div className={privacy.otherSection}>
        ...
        <p>
          ...
          us:
          <ul>
            <li>By email: support@wayyeasy.in</li>
            <li>
              By visiting this page on our website:{" "}
              <a
                href="http://www.wayyeasy.in/contact"
                target="_blank"
                rel="noopener noreferrer"
              >
                Contact page
            ...
            <li>By phone number: (+91) 9748 9769 22</li>
          </ul>
        </p>
      </div>
    </Paper>
